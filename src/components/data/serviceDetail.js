...
export const homePageService = [
  {
    ...
    subDesc: "Worldwide",
    para: "PDHS International Express connects Pakistanis to businesses and individuals around the world. Delivering to over 220+ destinations worldwide, PDHS provides fast, secure, and reliable service to its customers. ",
  },
  {
    title: "Service 02",
    description: "Courier Services",
    subDesc: "Local & Domestic",
    para: "PDHS is one of the leading and promising companies in the field of courier and one of the most reliable, economical and sound company of Pakistan.",
  },
  {
    title: "Service 03",
    description: "Cash On Delivery",
    subDesc: "Nationwide",
    para: "PDHS ensures smooth delivery of your orders with no risk of fraud or default.COD allows the customer to choose a product of their liking for home delivery, and pay at the time the product has been delivered.",
  },
];
